...
const buttonVariants = {
  ...
  link_enabled:
    "text-background hover:text-gray-01 border-none font-semibold bg-primary px-4 py-2 rounded-lg",
  link_disabled:
    "text-gray-04 hover:text-gray-03 border-none bg-gray-03 hover:bg-gray-02 px-4 py-2 rounded-lg",
